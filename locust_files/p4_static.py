...
class AllTasks(TaskSet):
    ...
    # TODO: with this setup locust is 10x more likely to perform a read action over write
    # we probably need to remove some of this randomness
    @task
